...
import favoritesImage from './img/resource/resource_favorites.png';
import hashtagImage from './img/resource/resource_hashtag.png';
import hashtagModalImage from './img/resource/resource_hashtag_modal.png';
import hashtagCompleteImage from './img/resource/resource_hashtag_complete.png';
import cropModalImage from './img/resource/resource_crop_modal.png';
import cropToggleImage from './img/resource/resource_crop_toggle.png';
import deleteImage from './img/resource/resource_delete.png';
...
<img src={favoritesImage} width="400" />
...
<img src={hashtagImage} width="400" />

데이터셋의 특징 또는 해시태그를 변경합니다.


<img src={hashtagModalImage} width="400" />

**저장** 버튼을 클릭하여 수정작업을 완료하고 즉시 반영된 해시태그 확인이 가능합니다.

<img src={hashtagCompleteImage} width="400" />
...
<img src={cropModalImage} width="400" />

**이미지 크롭 설정 추가** 버튼을 클릭하면 분할된 이미지를 생성하고 활성화 버튼을 눌러 사용합니다.

<img src={cropToggleImage} width="400" />
